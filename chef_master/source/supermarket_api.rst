...
Search returns cookbooks that match a query. The query syntax is a simple, fuzzy text search on cookbook names, cookbook descriptions, and the cookbook owners' usernames.
